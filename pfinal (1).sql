...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spNuevaReserva` (IN `pId_Usuario` INT, IN `pFechaInicio` DATE, IN `pFechaFin` DATE)  NO SQL
INSERT INTO `reservas`( `id_usuario`, `fecha_inicio`, `fecha_fin`) VALUES (pId_Usuario,pFechaInicio,pFechaFin)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `spNuevaReservas_estancias` (IN `pIdReserva` INT, IN `pIdEstancia` INT, IN `pFechaInicio` DATE)  NO SQL
INSERT INTO `reservas_estancias`(`id_reserva`, `id_estancia`, `fecha_inicio`) VALUES (pIdReserva,pIdEstancia,pFechaInicio)$$
...
(2, 2, '2020-05-12', '2020-05-13'),
(3, 2, '2020-05-14', '2020-05-17');
...
--
-- Volcado de datos para la tabla `reservas_viajes`
--
